...
im.crop((left, top, right, bottom)).save('Output.png', quality=95)

image = cv2.resize(image, (512, 512))

cv2.imshow('ID-CARD-DETECTOR : ', image)

image_cropped = cv2.imread('Output.png')
image_cropped = cv2.resize(image_cropped, (512, 512))
